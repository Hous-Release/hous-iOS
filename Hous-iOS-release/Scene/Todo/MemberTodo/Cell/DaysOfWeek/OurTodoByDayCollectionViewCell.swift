...
protocol DidTapOurTodoByDayDelegate: AnyObject {
...
final class OurTodoByDayCollectionViewCell: UICollectionViewCell {
  ...
  var id: Int?
  var delegate: DidTapOurTodoByDayDelegate?
  ...
  override var isSelected: Bool {
    didSet {
      if isSelected {
        ...
        delegate?.didTapOurTodo(todoId: id)
      }
    }
  }
}
...
extension OurTodoByDayCollectionViewCell {
  ...
  func setCell(_ todoName: String, _ todoId: Int, _ assignees: [String]) {
