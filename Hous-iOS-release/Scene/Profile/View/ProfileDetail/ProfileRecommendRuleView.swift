...
final class ProfileRecommendRuleView: UIView {
  ...
  private func render() {
    for idx in 0...1 {
      ...
      recommendRuleStackItem.setLabelText(recommendRuleList[idx])
...
//      make.bottom.equalToSuperview().offset(-32)
  ...
  func reloadRuleData() {
    for idx in 0...1 {
      guard let stackItem = recommendRuleStackView.arrangedSubviews[idx]
              as? ProfileRecommendRuleStackItemView else { return }
      stackItem.setLabelText(recommendRuleList[idx])
    }
  }
}
