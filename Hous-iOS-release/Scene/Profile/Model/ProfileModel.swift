...
PersonalityAttributeDescription(attributeName: "빛", attributeDescription: "빛에 예민한 사람들은 보통\n어쩌구 저쩌구를 하는 어찌\n뭐뭐를 조심하면 좋을지"),
PersonalityAttributeDescription(attributeName: "소음", attributeDescription: "소음에 예민한 사람들은\n제발 밤에 음악 틀고 춤 좀\n추지 말아주세요 제발"),
PersonalityAttributeDescription(attributeName: "냄새", attributeDescription: "냄새에 민감한 사람들을\n위해서라도 밤 늦게 음식을\n먹지 않지만 치킨은 먹지."),
PersonalityAttributeDescription(attributeName: "내향", attributeDescription: "사람들이랑 놀고 싶은\n마음은 이해하지만 기 너무 안\n빨리게만 조심 좀.."),
PersonalityAttributeDescription(attributeName: "정리 정돈", attributeDescription: "내가 할 소리는 아니\n지만 정리 정돈에 예민한 사람들을\n위해 정리정돈 좀 하자..")]
