...
enum ProfileTestActionControl: Equatable {
  ...
  static func == (lhs: Self, rhs: Self) -> Bool {
    switch (lhs, rhs) {
    case (.didTabQuit, .didTabQuit), (.didTabForward, .didTabForward),
      (.didTabBackward, .didTabBackward), (.didTabFinish, .didTabFinish), (.none, .none):
      return true
    case let (.didTabAnswer(answer: _, questionNum: questionNumLeft),
              .didTabAnswer(answer: _, questionNum: questionNumRight)):
