...
final class ProfileGraphCollectionViewCell: UICollectionViewCell {
  ...
  func bind(_ data: ProfileModel) {
    ...
    self.profileGraphBoxView
      .profileGraphView.profileGraphBackgroundView.backgroundShapeLayer.fillColor =
    data.personalityColor.graphBackgroundColor.cgColor
    self.profileGraphBoxView.profileGraphView.profileGraphView.graphShapeLayer.fillColor =
    data.personalityColor.graphColor.cgColor
    self.profileGraphBoxView.profileGraphView.profileGraphView.dataList =
    data.typeScores
  }
}
