//
//  MateProfileGraphCollectionViewCell.swift
//  Hous-iOS-release
//
...
final class MateProfileGraphCollectionViewCell: UICollectionViewCell {
  ...
  func bind(_ data: ProfileModel) {
    ...
    self.profileGraphBoxView
      .profileGraphView
      .profileGraphBackgroundView
      .backgroundShapeLayer
      .fillColor = data.personalityColor.graphBackgroundColor.cgColor
    self.profileGraphBoxView
      .profileGraphView
      .profileGraphView
      .graphShapeLayer
      .fillColor = data.personalityColor.graphColor.cgColor
